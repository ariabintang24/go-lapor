...
class ResidentController extends Controller
{
    ...
    public function store(StoreResidentRequest $request)
    {
        ...
        Swal::toast('Data Masyarakat Berhasil Ditambahkan', 'success')->timerProgressBar(3000);
    ...
    public function update(UpdateResidentRequest $request, $id)
    {
        ...
        //simpan data
        $this->residentRepository->updateResident($data, (int) $id);

        Swal::toast('Data Masyarakat Berhasil Diubah', 'success')->timerProgressBar(3000);
    ...
    public function destroy(string $id)
    {
        ...
        Swal::toast('Data Masyarakat Berhasil Dihapus', 'success')->timerProgressBar(3000);
